...
import (
	...
	"github.com/Nahom7wos/Airlines-Booking-System/payment"
)

// TicketService implements ticket.TicketService interface
type TicketService struct {
	ticketRepo ticket.TicketRepository
}

// NewTicketService will create new TicketService object
func NewTicketService(destRepo ticket.TicketRepository) ticket.TicketService {
